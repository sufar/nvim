...
require("flutter-tools").setup {
  ...
  debugger = { -- integrate with nvim dap + install dart code debugger
    ...
    register_configurations = function(paths)
      ...
      dap.adapters.dart = dap_flutter.adapter
      --  <put here config that you would find in .vscode/launch.json>
      dap.configurations.dart = dap_flutter.dap
    end,
  },
  ...
  closing_tags = {
    -- To change this, :h LineNr
    highlight = "LineNr", -- highlight for the closing tag
  ...
  lsp = {
    ...
    on_attach = my_custom_on_attach.on_attach,
